...
{
    'name': 'EMM Purchase Reports',
    'version': '1.0',
    'category': 'EMM/Reporting/Purchase',
    'description': """
    ...
    'depends': [
        'via_purchase_hr',
        'via_jasper_report_utils_hr',
    ],
    'data': [
        'report/pr_fulfillment_and_po_tracking/pr_fulfillment_and_po_tracking_registration.xml',
        'report/pr_fulfillment_and_po_tracking/pr_fulfillment_and_po_tracking_qty_registration.xml',
        'report/pr_fulfillment_and_po_tracking/pr_fulfillment_and_po_tracking_val_registration.xml',
